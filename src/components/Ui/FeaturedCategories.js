            ...
            <div className='grid grid-cols-4 gap-5 mt-10'>
                ...
                <div>
                    <Link href="/motherboard">
                        <h3 className='border-2 p-4 rounded-md text-center'>Motherboard  </h3>
                    </Link>
                </div>
                <div>
                    <Link href="/ram">
                ...
                <div>
                    <Link href="/powerSupplyUnit">
                        <h3 className='border-2 p-4 rounded-md text-center'>Power Supply Unit  </h3>
                    </Link>
                </div>
                <div>
                    <Link href="/storageDevice">
                        <h3 className='border-2 p-4 rounded-md text-center'>Storage Device  </h3>
                    </Link>
                </div>
                <div>
                    <Link href="/monitor">
